---
title: "申万玻璃基板-AI芯片光模块先进封测产业化节奏及标的梳理"
date: 2026-06-17
tags: [调研纪要, AI, 半导体, 光通信, PCB, 先进封装]
---
...
五、相关标的
1）电子/面板封测：京东方、TCL(今康宁拜访)、沃格、水晶、凯盛科技+长信科技；
2）封装基板：深南、兴森；预计后续资本化：群策/欣兴、礼鼎/臻鼎、安捷利美维、越亚
3）化工材料：天承科技（TGV电镀液）、艾森（TGV光刻胶）、鼎龙（板级封装用CMP抛光垫）、雅克（前驱体）；
4）机械设备：激光钻孔-帝尔、大族、英诺、联赢激光等；曝光-芯碁微装；
5）玻璃基材：力诺药包（半导体级中硼硅玻璃原片厂商，小尺寸基板）、旗滨集团、戈碧迦（电子布+半导+TGV基材等）
...
20260526 华为韬定律点评；
202606 申万建材持续推荐AI新材料：电子布、TGV玻璃基板、金刚石散热材料；
